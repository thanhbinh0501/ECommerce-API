export const ErrorCode = {
  ...
  PRODUCT_ALREADY_EXIST: 'NEST-1005',
  PRODUCT_CATEGORY_ALREADY_EXIST: 'NEST-1006',
  COLOR_ALREADY_EXIST: 'NEST-1007',
  ROM_ALREADY_EXISTS: 'NEST-1008',
  VARIANT_ALREADY_EXISTS: 'NEST-1009',
